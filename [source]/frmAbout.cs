...
{
  // Constant values
  const string AppTitle = "iTuner";
  const string AppDescription = "An great extension to an already amazing program. Adds global hotkey, notifications, and 'stop after current song' support to iTunes.";
